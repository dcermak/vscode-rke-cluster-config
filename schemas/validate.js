...
// from https://rancher.com/docs/rke/latest/en/example-yamls/#full-cluster-yml-example
const clusterYamlFull = YAML.parse(`nodes:
    - address: 1.1.1.1
      user: ubuntu
      role:
        - controlplane
...
if (validate(invalidClusterYaml)) {
  throw new Error(
    `Invalid yaml was successfully validated: ${inspect(invalidClusterYaml, {
      depth: null,
    })}`
  );
}
